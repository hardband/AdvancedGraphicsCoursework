...
public:
	...
	//Added a contructor to set texture
	ParticleEmitter(string texturePath);
	...
	*/
	...
	void	SetParticleRate(float rate)		{particleRate = rate;nextParticleTime = particleRate;}
	...
	*/
	...
	//New method to set texture
	void SetTexture(string path);

	//New method to give the particle emitter a position
